 ...
 *      Author: wong
 *      Author: Coulby Nguyen (932-525-439)
 */
...
public:
    ...
    //to get the value fo the coordinates of the next move
    int get_row();
    int get_col();
    //to set the coordinates of the next move
    void set_row(int);
    void set_col(int);
...
private:
    ...
    //to hold the coordinates of the next move
    int row;
    int col;
    /**
